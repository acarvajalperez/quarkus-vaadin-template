...
import es.opplus.front.views.example.events.EventsRoute;
import es.opplus.front.views.enlace1.Enlace1;
import es.opplus.front.views.example.pushdemo.PushDemoRoute;
...
@Push
 */
public class MainLayoutBak extends AppLayout implements RouterLayout, AfterNavigationObserver {

    private final H1 currentViewName = new H1();

    private static final Map<Class<? extends Component>, String> routes = new LinkedHashMap<>();
    static {
        routes.put(Enlace1.class, "Bandeja de tareas");
        ...
        routes.put(Enlace2.class, "About");
